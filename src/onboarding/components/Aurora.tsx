...
void main() {
  ...
  float midPoint = 0.20;
  float auroraAlpha = smoothstep(midPoint - 0.5, midPoint, intensity);

  vec3 auroraColor = intensity * rampColor;

  vec4 aurora = vec4(auroraColor, auroraAlpha);
  vec4 background = vec4(0.0, 0.0, 0.0, 1.0);
  vec4 composite = mix(background, aurora, uBlend);
...
export default function Aurora({
  colorStops = ['#4cd696', '#2ea36b', '#34d3c3'],
  amplitude = 1.0,
  speed = 1.0,
  blend = 0.5,
}: AuroraProps) {
