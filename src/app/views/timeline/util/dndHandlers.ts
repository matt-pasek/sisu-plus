...
export const getCourseDragData = (course: TimelineCourse, periodCountOverride?: number): TimelineCourseDragData => {
  return {
    kind: 'timeline-course',
...
export const isTimelineCourseDragData = (value: unknown): value is TimelineCourseDragData => {
  return (
    typeof value === 'object' &&
    value != null &&
    'kind' in value &&
...
export const isTimelineDropData = (value: unknown): value is TimelineDropData => {
